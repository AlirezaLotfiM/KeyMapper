...
- The mini player turns the current cover into a full-card cinematic backdrop with glass controls, a contrast veil, theme accents, and a proper vector maximize control.
