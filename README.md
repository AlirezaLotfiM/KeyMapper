...
- The mini player turns the current cover into a genuinely rounded, edge-to-edge cinematic backdrop with subtle grain, slow artwork drift, glass controls, high-contrast metadata, theme accents, and a proper vector maximize control. Mini-player hover states change opacity without painting distracting blocks behind the buttons.
